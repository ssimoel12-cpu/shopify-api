...
async def get_product(session, site, proxy=None):
    urls = [
        ...
        f"{site}/collections/frontpage/products.json?limit=1",
        f"{site}/collections/shop/products.json?limit=1",
        f"{site}/collections/all.json?limit=1",
        f"{site}/collections/featured/products.json?limit=1",
        f"{site}/collections/best-sellers/products.json?limit=1",
        f"{site}/collections/new/products.json?limit=1",
    ]
    headers = {
                ...
                async with session.post(
                    ...
                    if status1 == 200:
                        ...
                        if tx_status == "success":
                            ...
                            return JSONResponse({
                                "Status": False,
                                "Response": tx_message or str(error_msg) or "Declined",
